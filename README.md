...
```
You may also cite 'Mirror-based ultrasound system for hand gesture classification through convolutional neural network and vision transformer' which was a precursor to this work. Here is the plain text citation: Bimbraw, K., & Zhang, H. K. (2024, April). Mirror-based ultrasound system for hand gesture classification through convolutional neural network and vision transformer. In Medical Imaging 2024: Ultrasonic Imaging and Tomography (Vol. 12932, pp. 218-222). SPIE.
